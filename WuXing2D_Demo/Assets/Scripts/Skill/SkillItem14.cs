...
namespace WuXingSkill
{
    ...
    /// 技能组件：改变技能使用次数
    /// </summary>
    public class SkillItem14 : SkillItem
    {
        ...
        public override bool LaunchSkill(GameObject origin, SkillControl skillControl, bool free)
        {
            ...
            while (m_selectCard.Count > 0)
            {
                ...
                skillPara.m_index = m_index;
                skillPara.m_num = m_num;
                skillPara.m_skillConstraint = null;

                GameListener.Instance().ChainEventNotify(ChainEventID.evt_skillnum, skillPara);
            }
