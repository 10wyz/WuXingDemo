...
{
    public class SelectEmphasizeDisplay : AnimationDisplay
    {
        private int m_triggerTimes;
        public SelectEmphasizeDisplay()
        {
            m_state = null;
            m_triggerTimes = 0;
        }
        ...
        void Start()
        {
            ...
            {
                if (clips[i].name == "SelectEmphasize")
                {
                    //创建新事件
        ...
        private void EndAnimation()
        {
            ...
            if (m_triggerTimes == 1)
            {
                ...
                GameObject.Destroy(this.gameObject.GetComponent<SelectEmphasizeDisplay>());
            }
