...
{
    public class LaunchEmphasizeDisplay : AnimationDisplay
    {
        private int m_triggerTimes;
        public LaunchEmphasizeDisplay()
        {
            m_state = null;
            m_triggerTimes = 0;
        }
        ...
        void Start()
        {
            ...
            {
                if (clips[i].name == "LaunchEmphasize")
                {
                    //创建新事件
        ...
        private void EndAnimation()
        {
            ...
            if (m_triggerTimes == 1)
            {
                ...
                GameObject.Destroy(this.gameObject.GetComponent<LaunchEmphasizeDisplay>());
            }
